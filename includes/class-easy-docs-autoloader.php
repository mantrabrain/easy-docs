	...
	final class Easy_Docs_Autoloader {
		...
		function category_template( $template ) {
			if ( is_tax( 'docs_category' ) ) {
				return EASY_DOCS_DIR_NAME . '/includes/taxonomy-easy-docs-category.php';
			}
			return $template;
		}
		...
		function tag_template( $template ) {
			if ( is_tax( 'docs_tag' ) ) {
				return EASY_DOCS_DIR_NAME . '/includes/taxonomy-easy-docs-tag.php';
			}
			return $template;
		}
		...
		function get_easy_docs_single_template( $single_template ) {
			...
			if ( is_singular( 'docs' ) ) {
				$single_template = EASY_DOCS_DIR_NAME . '/includes/easy-single-template.php';
			}
