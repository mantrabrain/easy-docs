 ...
 * Creating the widget.
 */
class Easy_Docs_Widget extends WP_Widget {
	/**
...
<p>
	...
	function easy_docs_widgets_area() {
		...
		register_widget( 'easy_docs_widget' );
		register_sidebar(
			array(
				'name'          => __( 'Docs Sidebar', 'easy-docs' ),
				'id'            => 'docs-sidebar-1',
				'description'   => __( 'Widgets in this area will be shown on all docs single posts and cateory.', 'easy-docs' ),
