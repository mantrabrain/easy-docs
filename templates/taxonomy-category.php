	...
	<div id="primary" class="content-area grid-parent mobile-grid-100 grid-75 tablet-grid-75">
		...
		<div class="easy-page-header">
			<?php
				...
				the_archive_description( '<div class="easy-taxonomy-description">', '</div>' );

			if ( function_exists( 'yoast_breadcrumb' ) ) {
				echo '<div class="easy-tax-breadcrumb">' . do_shortcode( '[wpseo_breadcrumb]' ) . '</div>';
			}
			?>
		</div><!-- .page-header -->
			<?php
					...
					<div class="easy-cat-col" >
						<a class="easy-cat-link" href="<?php echo esc_url( get_term_link( $object->slug, $object->taxonomy ) ); ?>">
							...
							<span class="easy-cat-count">
								...
								<?php printf( __( '%1$s Articles', 'easy-docs' ), $count ); ?>
							</span>
						</a>
						</div>
