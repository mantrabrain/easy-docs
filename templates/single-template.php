...
<div class="wrap docs-wraper">
	<div id="primary" class="content-area easy-options-form-wrap grid-parent mobile-grid-100 grid-75 tablet-grid-75">
		<main id="main" class="docs-single-main" role="main">
			...
			while ( have_posts() ) :
				...
				<div class="entry-content easy-entry-content">
					<?php the_post_thumbnail(); ?>
					<?php the_content(); ?>
					<?php the_terms( $post->ID, 'docs_tag', '<ul class="easy-docs-tag"><span class="easy-docs-tag-label">Tagged Under: </span><li>', '</li><li>', '</li></ul>' ); ?>
				</div><!-- .entry-content -->
				<?php
				// If comments are open or we have at least one comment, load up the comment template.
				$is_comment_template_on = get_option( 'easy_search_has_comments' );
